...
1. **By adding context:** Providing additional context to existing issues,
   such as screenshots and code snippets, which help resolve issues.
1. **By resolving issues:** Typically this is done in the form of either
...
1. Does this change make Foundry better, even if only incrementally?
1. Are there clear bugs or larger scale issues that need attending?
1. Are the commit messages readable and correct? If it contains a breaking change, is it clear enough?
...
1. Perform a final audit for breaking changes.
